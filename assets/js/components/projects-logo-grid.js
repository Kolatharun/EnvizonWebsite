...
const logos = [
    { title: 'Zuddle', logo: 'assets/images/work/logos/zuddle-cursor.png', bgColor: '#080337', accentColor: '#FF6B6B', tags: ['Product Design', 'Web App'], url: 'project.html' },
    ...
    { title: 'Zuddle', logo: 'assets/images/work/logos/zuddle-cursor.png', bgColor: '#080337', accentColor: '#FF6B6B', tags: ['Interaction Design', 'Prototyping'], url: 'project.html' },
    ...
    { title: 'Zuddle', logo: 'assets/images/work/logos/zuddle-cursor.png', bgColor: '#080337', accentColor: '#FF6B6B', tags: ['Strategy', 'Web App'], url: 'project.html' },
    ...
    { title: 'Zuddle', logo: 'assets/images/work/logos/zuddle-cursor.png', bgColor: '#080337', accentColor: '#FF6B6B', tags: ['Product Design', 'Onboarding'], url: 'project.html' },
